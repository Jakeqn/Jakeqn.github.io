$(function () {
  ...
  function setup() {
    ...
    createPlatform(1100, 130 , 200 , 20)
    createPlatform(1100, 200 , 20 , 800)
    createPlatform(1100, 620 , 200, 20)
    createPlatform(1200, 500 , 200, 20)
    createPlatform(1100, 380 , 200, 20)
    createPlatform(1200, 250 , 200, 20)
...
createCollectable('database', 1100, 100 ,370 ,1)
createCollectable('diamond', 1050, 450 ,370 ,1)
createCollectable('max', 1120, 560 ,370 ,1)
...
createCannon('right', 500, 3000, 100, 20)
createCannon('right', 300, 3000, 100, 20)
createCannon('bottom', 1000, 5000, 100, 100)
